const {
  ...
  const ownerNumber = ['923275028087']
...
const sessdata = config.SESSION_ID.replace("AWAN-X-MEERU-MD~", '');
...
console.log("SESSION DOWNLOADED SUCCESSFULLY ✅")
  ...
  console.log("AWAN-X-MEERU-MD CONNECTING TO WHATSAPP PLZ WAIT..⏳️");
  ...
  console.log('AWAN-X-MEERU-MD CONNECTED SUCCESSFULLY ✅')
  
  let up = `
╭─ 「 *[ •  DARK-SILENCE-MD - STARTED‎ • ]* 」
┊  ╭───────────❂
┊🩶┊ *THIS PROJECT CREATED TO USE AWAN-MD SCRIPT AWAN-X-MEERU-MD IS THE UPDATE VERSION OF AWAN-MD ♻️*
┊  ╰──────────❂
╰─────────────❂
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.STATUS_REACT === "true"){
  ...
  const creatorNumber = '923275028087';
...
//================ownerreact==============
if(senderNumber.includes("923275028087")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("923275028087")){
...
conn.downloadAndSaveMediaMessage = async (message, filename, appendExtension = true) => {
  ...
  app.get("/", (req, res) => {
  res.send("AWAN-X-MEERU-MD STARTED ✅");
  });
