...
cmd({
  ...
  try {
    ...
    const _0x57d52f = await _0xaf8db8.sendMessage(_0x1220b5, {
      ...
      'caption': "\n*❖AWAN-X-MEERU-MD ᴛᴡɪᴛᴛᴇʀ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ❖*  \n*🔢 ʀᴇᴘʟʏ ʙᴇʟᴏᴡ ᴛʜᴇ ɴᴜᴍʙᴇʀ*\n\n*ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🎬*\n\n*1.1*     ┃  *ꜱᴅ Qᴜᴀʟɪᴛʏ*\n*1.2*     ┃  *ʜᴅ Qᴜᴀʟɪᴛʏ*\n\n*ᴀᴜᴅɪᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🎧*\n\n*2.1*     ┃  *ᴀᴜᴅɪᴏ*\n*2.2*     ┃  *ᴅᴏᴄᴜᴍᴇɴᴛ*\n*2.3*     ┃  *ᴠᴏɪᴄᴇ*\n\n> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝑨𝑾𝑨𝑵𝒁𝑨𝑫𝑨👑\n"
    }, {
      'quoted': _0x52bd10
    });
...
cmd({
  ...
  try {
    ...
    _0x788d94.react('⬆️');
    let _0x3ba839 = "\n*❖AWAN-X-MEERU-MD ᴍꜰɪʀᴇ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ❖*\n*ꜰɪʟᴇ ɴᴀᴍᴇ :* " + _0x107843 + "\n\n*ꜰɪʟᴇ ᴛʏᴘᴇ :* " + _0xecfe76 + "\n\n> AWAN-X-MEERU-MD ✻\n        ";
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'caption': _0x1d0aed.title + " |  *𝑨𝑾𝑨𝑵 𝒁𝑨𝑫𝑨👑*\n\n> AWAN-X-MEERU-MD"
                }, {
                  'quoted': _0x171143
                });
              } else {
                  ...
                  await _0x3dfd8e.sendMessage(_0x4a183a, {
                    ...
                    'contextInfo': {
                      ...
                      'externalAdReply': {
                        ...
                        'body': "Download powered by𝑨𝑾𝑨𝑵 𝒁𝑨𝑫𝑨👑",
                        'mediaType': 0x1,
